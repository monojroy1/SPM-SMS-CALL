...
banner() {
    ...
    echo -e "\e[1;34m Downloading...\e[0m"
    echo -e "\e[1;32m         BAD BOY  \e[0m"
    echo -e "\e[4;32m   HI I'M MONOJ ROY \e[0m"
    echo " "
    echo "NOTE: Kindly move to the PIP version Of SPM-SMS-CALL for more stability."
    echo " "
}
...
do
    ...
    echo " "
    echo "Press 1 To  Start SMS  SPM-SMS-CALL "
    echo "Press 2 To  Start CALL SPM-SMS-CALL "
    echo "Press 3 To  Start MAIL  (Not Yet Available)"
    ...
    if [ $ch -eq 1 ];then
        ...
        echo -e "\e[1;34m RUN SPM-SMS-CALL Again..."
        pause
        exit
    elif [ $ch -eq 5 ];then
        banner
